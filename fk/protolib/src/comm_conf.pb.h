...
class CommConf : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:config.CommConf) */ {
 public:
  ...
  bool has_transfer_port_start() const;
  void clear_transfer_port_start();
  static const int kTransferPortStartFieldNumber = 3;
  ::google::protobuf::uint32 transfer_port_start() const;
  void set_transfer_port_start(::google::protobuf::uint32 value);

  // optional uint32 routersvr_port_start = 4;
  bool has_routersvr_port_start() const;
  void clear_routersvr_port_start();
  static const int kRoutersvrPortStartFieldNumber = 4;
  ...
  static const int kConnsvrPortStartFieldNumber = 5;
 ...
 private:
  ...
  void set_has_transfer_port_start();
  void clear_has_transfer_port_start();
  ...
  ::google::protobuf::uint32 transfer_port_start_;
...
// optional uint32 transfer_port_start = 3;
inline bool CommConf::has_transfer_port_start() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void CommConf::set_has_transfer_port_start() {
  _has_bits_[0] |= 0x00000004u;
}
inline void CommConf::clear_has_transfer_port_start() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void CommConf::clear_transfer_port_start() {
  transfer_port_start_ = 0u;
  clear_has_transfer_port_start();
}
inline ::google::protobuf::uint32 CommConf::transfer_port_start() const {
  // @@protoc_insertion_point(field_get:config.CommConf.transfer_port_start)
  return transfer_port_start_;
}
inline void CommConf::set_transfer_port_start(::google::protobuf::uint32 value) {
  set_has_transfer_port_start();
  transfer_port_start_ = value;
  // @@protoc_insertion_point(field_set:config.CommConf.transfer_port_start)
}
